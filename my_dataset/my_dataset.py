...
def load_data(batch_size:int=2) -> object:
    ...
    train_dataset = My_Dataset('C:/cx/paper/2022001/code/data/train', train_samples)
    val_dataset = My_Dataset('C:/cx/paper/2022001/code/data/validation', validation_samples)
